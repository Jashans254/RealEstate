...
export default function Home() {
  ...
  return (
    <div>
     ...
     lg:text-6xl '>Find Your Next 
      <span className='text-slate-500'>perfect</span> <br />
      place with ease
     </h1>
    <div className='text-gray-400 text-xs sm:text-sm'>
      Geet Estate is the best place to find your next perfect place 
      to live. 
      <br />
      ...
      <Swiper navigation>
      {
        ...
        offerListings.map((listing)=> (
          <SwiperSlide>
            ...
            className='h-[500px]' key={Math.random(listing._id)}>
    ...
    <div className='max-w-6xl max-auto p-3 flex flex-col gap-8
    my-10'>
        {offerListings && offerListings.length>0 && (
          <div className=''>
                  <div className='my-3'>
                  ...
                  <div className='flex flex-wrap gap-4'>
                    {offerListings.map((listing)=> {
                      <ListingItem listing={listing} key={Math.random(listing._id)}/>
                    })}
                  </div>
          </div>
        )}
          ...
          <div className=''>
                  ...
                  <div className='flex flex-wrap gap-4'>
                    {rentListings.map((listing)=> {
                      <ListingItem listing={listing} key={Math.random(listing._id)*6}/>
