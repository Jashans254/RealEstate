         ...
         <div className=' flex flex-col gap-4 flex-1 '>
              ...
              <div className='flex flex-wrap gap-6'>
                <div className='flex gap-2'>
                  <input type="checkbox" is='sell'  className='w-5' />
                  <span>Sell</span>
                  <input type="checkbox" is='rent'  className='w-5' />
                  <span>Rent</span>
                  <input type="checkbox" is='parking'  className='w-5' />
                  <span>Parking Spot</span>
                  <input type="checkbox" is='furnished'  className='w-5' />
                  <span>furnished</span>
                  <input type="checkbox" is='offer'  className='w-5' />
                  <span>Offer</span>
                </div>
              </div>
         ...
         <div className='flex flex-col flex-1 gap-4'>
             ...
             <div className='flex gap-4 '>
                <input type="file" id='images' accept='image/*' multiple
                 ...
                 rounded upppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
